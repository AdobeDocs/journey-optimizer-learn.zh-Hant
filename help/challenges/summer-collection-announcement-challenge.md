...
在區段產生器中，您可以看到預估的合格輪廓數目。 如果您使用訓練沙箱資料，1.29 K 中有約 753 個合格輪廓。

>[!NOTE]
>由於需要回填現有輪廓，因此現有輪廓可能需要最多 24 小時才會顯示區段成員資格。

**區段已新增合格輪廓：**

您可以導覽至區段詳細資料檢視上所列之其中一個輪廓，以檢查已新增至區段的輪廓是否符合資格。

在輪廓頁面上，檢查[!UICONTROL 屬性]以確認其所符資格：層次應為銀、金、鉑或鑽石。

![輪廓屬性](assets/C1-S1-profile-attributes.png)
...
區段欄位：**[!UICONTROL 屬性]** > **[!UICONTROL XDM 個人輪廓]** > **[!UICONTROL 忠誠度]** > **[!UICONTROL 層級]**
...
1. 新增測試輪廓：Louise Petti：
   * 身分識別命名空間： *Luma CRM ID*
   * 身分識別值： *d1f132f9f9502bba047a6ec86c4b61f9*
...
1. 新增測試輪廓：Stanleigh Stooke：
   * 身分識別命名空間：*Luma CRM ID*
   * 身分識別值：`4f34057d9d9e792c28ba18ecae378e98`
2. 選取測試輪廓：Stanleigh Stooke。
3. 向自己傳送一份校樣。
