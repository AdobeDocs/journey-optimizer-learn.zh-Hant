...
+ 行銷活動 {#create-campaigns}
  + 動作行銷活動 {#action-campaigns}
    ...
    + [建立程式碼型體驗行銷活動](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/create-a-code-based-experience-campaign)
...
+ 歷程 {#journeys}
  ...
  + [將歷程節點儲存為片段](/help/journeys/journey-fragments.md)
  + 使用案例 {#use-cases}
...
+ [忠誠度](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer-learn/loyalty/introduction-to-loyalty/discover-journey-optimizer-loyalty)
...
+ 管道 {#channels}
  ...
  + 推播頻道{#push-channel}
    ...
    + [網路推播端到端教學課程](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer-learn/ajo-web-push/introduction)
...
+ 內容管理{#content-management}
  ...
  + 使用片段 {#fragments}
    ...
    + [使用 AEM 內容片段 (Managed Services)](/help/content-management/aem-content-fragments-managed-services.md)
...
+ 報告和監視 {#report-and-monitor}
  ...
  + [監視自訂動作](/help/report-and-monitor/custom-action-monitoring-report.md)
