...
+ 使用案例 {#use-cases}
   ...
   + [使用Web SDK在Adobe Journey Optimizer中使用即時天氣資料個人化優惠方案](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction)
   + [使用排名公式在Journey Optimizer中提供個人化優惠](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction)
