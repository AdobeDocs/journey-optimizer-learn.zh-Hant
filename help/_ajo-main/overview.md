...
本使用手冊包含了Adobe Journey Optimizer功能的相關影片和教學課程。 練習運用您已學到的知識，參加 [Journey Optimizer挑戰](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites).
