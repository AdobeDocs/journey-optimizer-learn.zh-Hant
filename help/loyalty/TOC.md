...
+ {hide-from-toc}[開始使用行銷人員的Journey Optimizer忠誠度](./overview.md)
...
+ 設定您的挑戰 {#configure-your-challenge}
  ...
  + {hide-from-toc}[透過忠誠度AI代理程式提出挑戰並獲得見解](./configure-your-challenge/create-challenges-and-get-insights-with-the-loyalty-ai-agent.md)
+ 套用並顯示您的挑戰 {#apply-and-display-your-challenge}
  + {hide-from-toc}[使用程式碼式體驗建置挑戰內容卡](./apply-and-display-your-challenge/build-a-challenge-content-card-with-a-code-based-experience.md)
