---
user-guide-title: 適用於Adobe Journey Optimizer中網頁體驗的AI支援決策
user-guide-description: 在本實驗中，您將學習如何使用Adobe Journey Optimizer建構決策系統。 您可以設定邏輯，結合財務設定檔和即時動作，找出最適合每位客戶的產品選件，然後透過網頁橫幅和簡訊穩定部署。
role: User
...
# 適用於Web體驗的AI支援決策 {#ai-powered-decisioning-for-web-experiences}

+ [簡介](/help/summit-lab-2026/introduction.md)
+ [設定實驗室環境](/help/summit-lab-2026/set-up-the-lab-environment.md)
...
+ [講座2 — 瞭解排名方法](/help/summit-lab-2026/lecture-2-understand-ranking-methods.md)
